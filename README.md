...
```bash
python -m pip install --upgrade 'wheels/market_data_api-0.8.2-py3-none-any.whl[client]'
```
...
- **本机代理读不到基座**：`mdapi-local` 及其安装包必须升级到 0.8.2 并重新启动。
